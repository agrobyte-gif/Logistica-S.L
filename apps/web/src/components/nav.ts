...
export const NAV: NavGroup[] = [
  ...
  },
  {
    ...
    fase: 6,
    items: [
      { label: 'Caja chica', path: '/finanzas/caja', available: true, fase: 6 },
      { label: 'Cuentas por cobrar', path: '/finanzas/cxc', available: true, fase: 6 },
      { label: 'Cuentas por pagar', path: '/finanzas/cxp', available: true, fase: 6 },
    ],
  },
  { label: 'Facturación', icon: '🧾', path: '/facturacion', available: true, fase: 6 },
  { label: 'Control Tower', icon: '🗼', path: '/control-tower', available: true, fase: 7 },
  { label: 'Reportes', icon: '📊', path: '/reportes', available: true, fase: 7 },
  { label: 'Inteligencia', icon: '🤖', path: '/inteligencia', available: true, fase: 8 },
